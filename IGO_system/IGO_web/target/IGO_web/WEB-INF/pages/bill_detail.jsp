        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        <div class="col-md-2"><a href="/bill/bill_detail?bibi=${sessionScope.billd.bid}" class="btn btn-default" role="button">修改订单</a></p> </div>
                        <div class="col-md-2"><a href="/bill/bill_submit?bibi=${sessionScope.billd.bid}" class="btn btn-default" role="button">结算</a> </div>
                        <div class="col-md-2"><a href="/bill/bill_accept?bibi=${sessionScope.billd.bid}" class="btn btn-default" role="button">已收货</a> </div>
                    </div>
                    <div class="panel-footer text-right">
                        <button type="button" class="button"><a href="/bill/to_bill_list">返回</a></button>
                    </div>
                </div>
            </div>
        </div>
