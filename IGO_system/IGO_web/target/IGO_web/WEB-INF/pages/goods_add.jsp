    ...
    <div class="tray tray-center">
        ...
        <div class="theme-primary mw1000 center-block" style="width: 600px;margin-left: 400px">
            <div class="panel heading-border">
                <form:form action="/goods/goods_add" modelAttribute="goods" method="post" commandName="goods" id="admin-form" name="addForm">
                    ...
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="goodsId" class="field prepend-icon">
                                    <form:input path="goodsId" cssClass="gui-input" placeholder="商品编号"/>
                            ...
                            <div class="col-md-6">
                                <label for="goodsName" class="field prepend-icon">
                                    <form:input path="goodsName" class="gui-input" placeholder="商品名称"/>
                        ...
                        <div class="panel-footer text-right">
                            <button type="submit" class="button"> 添加商品 </button>
